...
<body>
    <div class="container-auto" id="main-container">
        <div class="row">
            <div class="col-md-7 p-4" id="form-col">
            ...
            <div class="col-md-5 p-4" id="content-col">
                <div class="row" id="content-row">
                    <div class="col-12 coluna text-center">
                        <h3>Atualização de Cadastro</h3>
                        <h5>Formulário para atualização de cadastro de clientes da DTS Distribuidora.</h5>
                        <img src="img/cadastro.svg" alt="cadastro">
                        <img src="img/LOGO_DTS.png" alt="dts">
                    </div>
                    <div class="col coluna text-center">
                        <h3>Termo de Privacidade</h3>
                        <p class="content lh-base text-start">"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."</p>
                    </div>
                </div>
            </div>
        </div>
